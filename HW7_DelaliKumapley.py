...
# Three lines of code.
  ...
  for word in textList:
    compareTextList.append((word.strip(string.punctuation)))
...
# depends on your coding style -- various styles are OK.)
  ...
  count = 0;
# compareTextList is the text in a list, wihtout punctuation
#word list is the specific words were looking for

  for word in compareTextList:
...
# various styles are OK.)
  ...
  ratioMath =  count / len(compareTextList) 
  return ratioMath
...
print('{} : {}'.format("bellsAAnFrequency", litCricFriend(['a', 'an'], theBells)))
print('{} : {}'.format("bellsTheFrequency", litCricFriend(['the'], theBells)))
print("cantoXIIAAnFrequency " + str(litCricFriend(['a','an'], cantoXII)))
print("cantoXIITheFrequency " + str(litCricFriend(['the'], cantoXII)))
...
# differently?
'''
Yes, the results show that Poe and Neruda use 'a' and 'an' differently, with Poe using indefinite clauses more frequently than his counterpart.

Yes, the results show that Poe and Neruda use 'the' differently, with Poe using definite clauses more frequently than his counterpart.
'''